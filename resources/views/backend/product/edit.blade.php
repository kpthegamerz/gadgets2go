...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          <label for="inputModel" class="col-form-label">Model <span class="text-danger">*</span></label>
          <input id="inputModel" type="text" name="model" placeholder="Enter model"  value="{{$product->model}}" class="form-control">
          @error('model')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          <label for="price" class="col-form-label">Price(SRP) <span class="text-danger">*</span></label>
