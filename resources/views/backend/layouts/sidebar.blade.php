<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('admin')}}">
    ...
    <div class="sidebar-brand-text mx-3">Gadgets<b style="color:#F98619">2Go</b></div>
  </a>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#courierCollapse" aria-expanded="true" aria-controls="courierCollapse">
      <i class="fas fa-image"></i>
      <span>Courier</span>
    </a>
    <div id="courierCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Product Options:</h6>
        <a class="collapse-item" href="{{route('courier.index')}}">Couriers</a>
        <a class="collapse-item" href="{{route('shipping.index')}}">Shipping Charges</a>
      </div>
    </div>
  </li>
  <li class="nav-item">
